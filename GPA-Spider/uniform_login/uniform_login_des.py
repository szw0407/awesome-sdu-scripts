...
def enc(dataByte: list, keyByte: list) -> list:
    ...
    ipLeft = [0 for _ in range(32)]
    ipRight = [0 for _ in range(32)]
    tempLeft = [0 for _ in range(32)]
    for k in range(32):
        ipLeft[k] = ipByte[k]
...
def pPermute(sBoxByte: list) -> list:
    pBoxPermute = [0 for _ in range(32)]
